...
const NewsletterBox = () => {
  ...
  return (
    <div className='text-center'>
        <p className='text-2xl font-medium text-gray-800'>Subscribe now & get 22% off</p>
        ...
        <form className='w-full sm:w-1/2 flex item-center gap-3 mx-auto mx-auto my-6 border pl-3'>
